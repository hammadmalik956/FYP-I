...
const CreateResource = () => {
  ...
  return (
    ...
    <h1 className=' text-xl font-sans border-r border-blue-400 py-2 w-[12rem] my-2'>Create Resource</h1>
      <TableExp tname="Rooms" headIcon={<DomainAddIcon/>} column={roomColD} mutfun ={addRoom} qurfun={useGetAllRoomsQuery()} />
      <TableExp tname="Students" headIcon={<PeopleAltIcon/>} column={studentColD} mutfun ={addStudent} qurfun={useGetAllStudentsQuery()} />
      <TableExp tname="Invigilators" headIcon={<AccountCircleIcon/>} column={invgColD} mutfun ={createInvg} qurfun={useGetAllInvigilatorsQuery()} />
